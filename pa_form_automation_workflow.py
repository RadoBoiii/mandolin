...
def extract_info_with_openai(text, prompt=None, model='gpt-3.5-turbo'):
    ...
    client = OpenAI(api_key=os.getenv('OPENAI_API_KEY', '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'))  # Replace with your key or set env var
    if prompt is None:
        prompt = (
...
#         {"role": "user", "content": prompt + '\n\n' + text}
#     ]
#     response = openai.ChatCompletion.create(model=model, messages=messages, max_tokens=512)
#     return response['choices'][0]['message']['content']
